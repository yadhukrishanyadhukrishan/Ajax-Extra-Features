...
async def start(client, message):
    ...
    if len(message.command) != 2:
        buttons = [[
            ...
            InlineKeyboardButton('💠 hdjd 💠', url='https://t.me/MWUpdatez'),
            InlineKeyboardButton('💠 UᎮDΛS 💠', url='https://t.me/OpusTechz')
            ],[      
    ...
    if len(message.command) ==2 and message.command[1] in ["subscribe", "error", "okay", "help"]:
        buttons = [[
            ...
            InlineKeyboardButton('💠 CbdjdΞL 💠', url='https://t.me/MWUpdatez'),
            InlineKeyboardButton('💠 jdjfjf 💠', url='https://t.me/OpusTechz')
            ],[      
            InlineKeyboardButton('♻️ HΞLᎮ ♻️', callback_data='help'),
            InlineKeyboardButton('♻️ ΛBOUT ♻️', callback_data='about')
            ],[
